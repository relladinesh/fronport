...
export default function Hero({ character = null }) {
  ...
  return (
    <section
      ...
      className="rounded-2xl p-6 sm:p-8 md:p-10 bg-gradient-to-br from-[rgba(220,238,238,0.09)]  border border-white/5 shadow-2xl relative overflow-hidden mx-auto bg-black "
    >
